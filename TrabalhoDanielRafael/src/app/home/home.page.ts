...
export class HomePage {
  ...
  public bebidas = [
    ...
    { codigo: 13, categoria: 4, descricao: 'Suco de laranja integral Pratts,100% natural, sem conservantes e não fermentado. ', nome: 'Suco de Laranja 900 ml',  valor: 4.99, imagens: ['SUCO LARANJA.jpg', 'laranja.png'],  visibled: false },
    ...
    { codigo: 16, categoria: 4, descricao: 'Sem adição de água, açúcar ou corantes.Variedade: corte de uvas americanas. Característica: suave; Temperatura ideal para consumo: 4º a 6ºC', nome: 'Suco de Uva 1 L',         valor: 7.99, imagens: ['SUCO UVA.png', 'suco de uva.png'],      visibled: false },
    ]
